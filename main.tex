...
\newmdenv[style=highlightstyle]{highlight}
...
\begin{document}
    ...
    \include{5-Writing/main}
    \include{6-Visual/main}
    \include{7-NewMedia/main}
    \include{8-conclusion/main}
