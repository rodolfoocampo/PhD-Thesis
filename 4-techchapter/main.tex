...
This typology emerged from emerged from a workshopped interaction and analysis presented in a paper at the GenAI and HCI workshop at CHI 2022. 
...
The principles are presented as follows, with the derivation for each found in the following sections. 
    ...
    \begin{itemize}
        \item \begin{highlight}\textbf{Bidirectional Communication}: Two-way communicative or conversational exchanges.\end{highlight}
        \item \begin{highlight}\textbf{A Shared Collaborative Space}: There is a common collaborative environment separate from instructions or chat interfaces.\end{highlight}
        \item \begin{highlight}\textbf{Mutual Influence}: Each party's perspectives and goals evolve as a result of the interaction and each agent drives the other to new unexpected directions.\end{highlight}
        \item \begin{highlight}\textbf{Mutual Understanding}: Each agent actively seeks to understand the other's world-models, goals, perspectives, preferences, etc.\end{highlight}
        \item \begin{highlight}\textbf{Iteration}: The creative product and the shared meanings evolve iteratively.\end{highlight}
        \item \begin{highlight}\textbf{Context-awareness}: Actors bring in the relevant context and act within it.\end{highlight}
    \end{itemize}


\textbf{A brief note on interaction vs action:} \begin{highlight}Throughout this thesis, I use the terms 'action' and 'interaction' interchangeably, but it is worth clarifying a nuanced extinction . An \textit{action} refers to an operation that acts directly on an artefact, which may or may not involve mutual awareness between human and AI. An \textit{interaction} refers to an exchange where the AI is aware of and responds to the human's behaviour, either through conversation or through mutually visible actions on a creation. For example, playing a note in a DAW where no AI agent is aware constitutes an action; playing a note while co-creating with an AI agent that can perceive and respond to it constitutes an interaction. In short, an interaction is a type of action that involves mutual awareness and an exchange of information between human and AI.\end{highlight}
