...
Lastly, a third component is considered as part of the framework for Dialogic Co-Creative AI: a three level characterisation of dialogue. 

\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{levels of dialogue.png}
    \caption{Levels of Dialogue}
...
\section{Principles for Dialogic Co-Creative AI}
