...
- As a core contribution, expanding on the above I propose a set of elements of dialogic co-creativity:
    ...
    \caption{Dialogic co-creativity as an interaction design concept is comprised of six essential elements: bidirectional communication, a shared space, iteration, mutual influence, mutual understanding, shared space and context-awareness. }
    \label{fig:enter-label}
\end{figure}
