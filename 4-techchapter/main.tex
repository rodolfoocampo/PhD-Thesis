...
This chapter addresses my core research question ("How can we design generative AI systems that act as effective co-creators, maintaining human agency while effectively leveraging the creative potential of this technology?") with a specific focus on research question regarding dialogic interaction (R1):
\begin{quote}
\begin{highlight}How to enable co-creative dialogues between humans and AI, and how does it influence the roles and effectiveness of human-AI co-creativity?\end{highlight}
\end{quote}
...
\begin{itemize}
\item \begin{highlight}\textbf{Bidirectional Communication:} Two-way conversational exchanges.\end{highlight}
\item \begin{highlight}\textbf{A Shared Collaborative Space:} A common collaborative environment.\end{highlight}
...
\item \begin{highlight}\textbf{Mutual Understanding:} Each agent actively seeks to understand the other's world-models, goals, perspectives, and preferences.\end{highlight}
\item \begin{highlight}\textbf{Iteration:} The creative product and shared meanings evolve iteratively.\end{highlight}
\item \begin{highlight}\textbf{Context-awareness:} Actors bring in relevant context and act within it.\end{highlight}
\end{itemize}
...
The following short-paper publication is provided below as the first part of this chapter. 
...
- As a core contribution, expanding on the above I propose a set of elements of dialogic co-creativity:
    ...
    \caption{Dialogic co-creativity as an interaction design concept is comprised of six essential elements: \begin{highlight}bidirectional communication, a shared collaborative space, mutual influence, mutual understanding, iteration, and context-awareness\end{highlight}. }
    \label{fig:enter-label}
\end{figure}
...
\subsection{\begin{highlight}Shared Collaborative Space\end{highlight}}
