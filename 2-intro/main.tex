...
The generative capabilities of these models, across not only language, but also music, images, videos, code, and more, raise many pressing ethical, philosophical, and economic questions. They also \begin{highlight}bring renewed attention to and expand the possibilities for\end{highlight} human-AI co-creativity.
...
\begin{highlight}\textbf{Problem definition:} The central problem addressed in this thesis therefore, is how can we design generative AI systems from the perspective of interaction design, such that they act as effective co-creators, maintaining human agency while effectively leveraging the creative potential of this technology? This problem can be further understood from two perspectives.\end{highlight}
...
I focus specifically on human–AI co-creativity within three creative domains: writing, image generation, and interactive new media music installations. 
...
This three-domain approach enabled the research to remain agile and highly relevant, capturing the core challenges of human-AI co-creativity across the most significant generative modalities as they emerged.\end{highlight}
...
\textbf{Chapter 2: Literature Review.} Chapter 2 reviews the literature relevant to the two research questions, covering a multidisciplinary literature across human creativity and computational creativity, human-computer interaction and emerging literature on human-AI co-creativity. 
 ...
 A key outcome of the analysis is that, while numerous interaction design principles exist in HCI, \begin{highlight}comprehensive principles specifically guiding human-AI co-creativity remain underdeveloped\end{highlight}.
...
The second part presents a more comprehensive framework for dialogic co-creativity, a novel contribution to the HCI literature as an interaction design concept. Alongside interaction \textit{through} and \textit{about} the creation, it comprises six key components: \begin{highlight}\textbf{bidirectional communication, shared collaborative space, mutual influence, mutual understanding, iteration, }and\textbf{ context-awareness}\end{highlight}. These components form an analytical lens for the subsequent chapters.
