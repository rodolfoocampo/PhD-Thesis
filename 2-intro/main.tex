...
\textbf{Problem definition:} The central problem addressed in this thesis therefore, is how can we design generative AI systems from the perspective of interaction design, such that they act as effective co-creators, maintaining human agency while effectively leveraging the creative potential of this technology? This problem can be further understood from two perspectives. 
...
In light of the emergence of chat-based interfaces as the predominant mode of interaction with language models, it might seem self-evident that dialogic interaction can enhance co-creativity. However, my characterisation of dialogue extends beyond bidirectional text exchanges. By drawing on philosophical, educational, and interdisciplinary dialogue literature, \hl{described in detail in Chapter 3}, I develop a more comprehensive construct of \emph{dialogic interaction} comprising six key elements:
...
\textbf{Sub-Questions:}
\begin{enumerate}
    \item \textbf{R1:} \emph{\hl{How to enable co-creative dialogues between humans and AI, and how does it influence the roles and effectiveness of human-AI co-creativity?}}
...
The selection of creative domains for this thesis was a strategic opportunistic response to the rapid advancements and public adoption of generative AI that occurred during the research period. While the project was initially scoped to focus on music, the explosion of LLMs and image models presented a unique opportunity to prototype and study the emerging challenges of human-AI co-creativity "in the wild."
...
This three-domain approach enabled the research to remain agile and highly relevant, capturing the core challenges of human-AI co-creativity across the most significant generative modalities as they emerged.
