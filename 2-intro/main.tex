...
\hl{\textbf{Problem definition:} The central problem addressed in this thesis therefore, is how can we design generative AI systems from the perspective of interaction design, such that they act as effective co-creators, maintaining human agency while effectively leveraging the creative potential of this technology? This problem can be further understood from two perspectives.}
