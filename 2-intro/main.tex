...
Throughout this thesis, I used AI both as an object of study and as a research partner. My thinking around AI evolved throughout this process, and given the aim of my thesis, it was important for me to maintain close involvement rather than outsource or automate the thinking.
I used AI primarily for proofreading and copy editing, helping me word things more clearly. English is not my first language, and AI helped me identify awkward phrasing and improve clarity. However, I always wrote the first version myself, and engaged in what I consider to have been a tight dialogic co-creative interaction. AI functioned as an editor and research assistant, while I maintained the guide through critical thinking and direction.
Beyond editing, I used AI in two additional ways. First, I used a language model to extract insights from hundreds of papers, helping me analyse large amounts of literature that I would not have been able to process by myself. Second, I used Cursor, a co-creative coding environment traditionally used for software development but capable of working with any file type, to validate consistency across all files in my thesis, checking for consistent terminology and citations.
