...
Dialogue has long been discussed in fields such as Human--Computer Interaction (HCI) and creative practice as a means to model interactions with computers and creative tools. Despite this, it remains under-formalised as an interaction design concept in HCI. My research, conducted as part of an Australian Research Council (ARC)-funded project exploring Dialogic Creative Artificial Intelligence (DCAI), builds on initial work by Bown et al \cite{Bown2020-oc} to address this gap. In the rest of the thesis, I refer to DCAI as Dialogic Co-Creative Intention signalling the focus on co-creative interaction and the relevance in the emerging field of Human-AI Co-Creativity. 
