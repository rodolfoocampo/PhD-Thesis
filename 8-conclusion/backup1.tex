...
\begin{enumerate}
    \item \textit{R1: \begin{highlight}How to enable co-creative dialogues between humans and AI, and how does it influence the roles and effectiveness of human-AI co-creativity?\end{highlight}}
    \item \textit{R2: What are the design principles can guide the development of effective generative AI systems that are co-creative with people?}
\end{enumerate}
