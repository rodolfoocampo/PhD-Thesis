...
After than, I will elaborate further on each question. I will do so in reverse order. First discussing how to enable co-creative dialogues between humans and AI and their influence on roles and effectiveness (R1), then synthesising these findings into design principles (R2). 
...
\section{R1: \begin{highlight}How to enable co-creative dialogues between humans and AI, and how does it influence the roles and effectiveness of human-AI co-creativity?\end{highlight}}
