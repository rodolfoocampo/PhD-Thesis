...
Chapter 5 argued that the main limitation we faced when employing generative AI image tools in a professional creative scenario for the production of magazine visuals was effectively controlling them. In particular, achieving a specific style needed for to align with the magazine's identity, controlling the structure of images and mantaining consistency of subject/objects. 

In Chapter 6, when leveraging a large language model to drive a generative soundscape for a new media installation, I outlined how the unpredictability of outputs and the tendency for the model to unexplainably fixated on a small subset of them represented a significant challenge.
