...
\begin{quote}
\textbf{Core Aim:} How can we design generative AI systems that act as effective co-creators, maintaining human agency while effectively leveraging the creative potential of this technology?  
\end{quote}
...
\begin{itemize}   
    \item \begin{highlight} emph{R1: How to enable co-creative dialogues between humans and AI, and how does it influence the roles and effectiveness of human-AI co-creativity?\end{highlight}
...
I address these questions by synthesising findings from my research studies, emerging literature, and observations from practice. 

In Chapter 3, I address the first part of R1 "How to enable co-creative dialogues between humans and AI" by proposing a framework for dialogic co-creativity comprising six core elements: \textbf{bidirectional communication, shared collaborative space, iteration, mutual influence, mutual understanding}, and \textbf{contextual awareness}. I also discussed three levels of co-creative dialogic interaction: pseudo-dialogue, weak asymmetric dialogue, and full dialogue \cite{Bown2024-yx}, each corresponding to different types of co-creative interactions. 

I address these questions by synthesising findings from my research studies, emerging literature, and observations from practice. In Chapter 3, I established a framework for dialogic co-creativity comprising six core elements: \begin{highlight}bidirectional communication, shared collaborative space, mutual influence, mutual understanding, iteration, and contextual awareness\end{highlight}. I also distinguished three levels of dialogic interaction: pseudo-dialogue, weak asymmetric dialogue, and full dialogue \cite{Bown2024-yx}. Throughout this thesis, I used this framework as an analytical lens to examine how dialogic elements influence roles, agency, and effectiveness in human-AI co-creativity.
...
I begin this chapter by tying back the elements of dialogue discussed in Chapter 3 to the levels of dialogue, and proposing that we can use these to understand three types of co-creators, each with an increasing degree of dialogic capabilities. 

Each level leads to different roles assumed from the user, and influenced the effectiveness of the interaction in different ways. 

From the studies in the preceding chapters and a survey of the literature and practice, I propose there are three levels of co-creative systems. Each level prioritises different dialogic elements and requires distinct design approaches. Table \ref{tab:co-creator-types} summarises these three types, their corresponding dialogue levels, and the design principles prioritised at each level.

\begin{table}[htbp]
\centering
\caption{Three types of co-creative systems: dialogue levels and prioritised design principles}
\label{tab:co-creator-types}
\begin{tabularx}{\textwidth}{X|X|X}
\toprule
\textbf{Type 1: Generative} & \textbf{Type 2: Communicative} & \textbf{Type 3: Collaborative} \\
\midrule
\textbf{Description} \newline Systems that operate primarily as generators with minimal dialogic capabilities. Enable exploration through generative variability and basic iterative workflows. Serve early stages of creative workflow for ideation and exploration. & \textbf{Description} \newline Systems that add conversational interaction to generative capabilities. Enable alignment of goals and intentions through dialogue, but remain limited in supporting interaction through the creation itself. & \textbf{Description} \newline Systems that integrate all previous elements and enable both human and AI contributions to the creative product. Allow interaction not only about the creation, but through the creation itself. Embedded in user workspace with awareness of context. \\
\midrule
\textbf{Dialogue Level} \newline Pseudo-dialogue & \textbf{Dialogue Level} \newline Weak asymmetric dialogue & \textbf{Dialogue Level} \newline Full dialogue \\
\midrule
\textbf{Design Principles to Prioritise} \newline Mutual Influence \newline Iteration & \textbf{Design Principles to Prioritise} \newline Bidirectional Communication \newline Mutual Understanding & \textbf{Design Principles to Prioritise} \newline Shared Collaborative Space \newline Context Awareness and Embeddedness \\
\bottomrule
\end{tabularx}
\end{table}
