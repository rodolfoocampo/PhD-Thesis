...
\midrule
\textbf{Description} & Systems that operate primarily as generators with minimal dialogic capabilities. Enable exploration through generative variability and basic iterative workflows. Serve early stages of creative workflow for ideation and exploration. & Systems that add conversational interaction to generative capabilities. Enable alignment of goals and intentions through dialogue, but remain limited in supporting interaction through the creation itself. & Systems that integrate all previous elements and enable both human and AI contributions to the creative product. Allow interaction not only about the creation, but through the creation itself. Embedded in user workspace with awareness of context. \\
\midrule
\textbf{Dialogue Level} & Pseudo-dialogue & Weak asymmetric dialogue & Full dialogue \\
\midrule
\textbf{Design Principles to Prioritise} & Mutual Influence \newline Iteration & Bidirectional Communication \newline Mutual Understanding & Shared Collaborative Space \newline Context Awareness and Embeddedness \\
\bottomrule
\end{tabularx}
\end{table}
